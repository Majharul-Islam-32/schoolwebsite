    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Add, edit, or remove teaching staff</p>
        </div>
        <button 
          onClick={() => openModal()}
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Name & Designation</th>
                ...
                <tr key={teacher.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2 py-1 text-xs rounded-full ${
                      teacher.isVisible ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                    }`}>
                      {teacher.isVisible ? 'Active' : 'Hidden'}
                    </span>
                  </td>
